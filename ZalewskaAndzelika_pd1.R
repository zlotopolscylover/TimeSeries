dane <- read.csv("WIG20.mst", sep=",",header=TRUE)
...
#Z otrzymanych powyzej wyników widzimy, ze kryterium AIC sugeruje model ARIMA(4,1,4), natomiast
#kryterium BIC sugeruje model ARIMA(0,1,0).

#Ponizej zbada³am jak zachowuja sie rezydua w tych obu modelach.
arma_AIC <- arima(z_diff,c(4,0,4))
